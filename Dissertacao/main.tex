...
%O texto começa com algumas construções de grafos livres de triângulos e com número cromático grande, predecessores do estudo de grafos com número cromático e cintura grandes. São apresentadas as construções de Tutte, Zykov, Mycielski e de planos projetivos. E em sequência, é apresentada uma demonstração do teorema de Erd\H{o}s.
...
\bibliographystyle{IEEEtranS}% citação bibliográfica alpha
