...
%pois note que um conjunto de $2d'$ vértices coloridos com uma mesma cor é um $K_{d',d'}$ monocromático, e com apenas $t' < \infty$ cores, alguma cor ocorre pelo menos $2d'$ vezes. Logo o número cromático de $H$ não é limitado por uma constante.
