...
Sejam $k$ e $g$ os parâmetros da conjectura de Erd\H{o}s e Hajnal, e seja $G = KG(2n,n-2x)$ um grafo de Kneser com número cromático grande. O número cromático de um grafo de Kneser $KG(n,r)$ é igual a $n-2r+2$ se $n \geq 2r$, e $1$ caso contrário, logo para $x\geq 0$ o número cromático de $G$ é $4x+2$. 
